            ...
            public void onClick(View view) {
                ...
                if(mayTinhNguyenGiaTruong !=null) {
                    if(databaseNguyenGiaTruong.findById(mayTinhNguyenGiaTruong.getId())==null){
                        ...
                        Toast.makeText(InsertActivityNguyenGiaTruong.this,"Mã Máy Tính Đã Tồn Tại",Toast.LENGTH_LONG).show();
                }
                else
                    Toast.makeText(InsertActivityNguyenGiaTruong.this,"Lỗi Khi Thêm",Toast.LENGTH_LONG).show();
...
//        alertDialogBuilder.setIcon(R.drawable.question);
        ...
        alertDialogBuilder.setNegativeButton("Không đồng ý", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(InsertActivityNguyenGiaTruong.this,"Bạn đã click vào nút không đồng ý",Toast.LENGTH_SHORT).show();
            }
        });
