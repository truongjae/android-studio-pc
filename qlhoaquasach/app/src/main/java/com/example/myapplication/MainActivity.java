...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hoaQuaSachList = database.getAll();
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(edtSearch.getText().toString().equals("")){
                    hoaQuaSachList.clear();
                    hoaQuaSachList.addAll(database.getAll());
                    setAdapter();
                }
                else{
                    HoaQuaSach hoaQuaSach = database.findById(Integer.parseInt(edtSearch.getText().toString()));
                    if(hoaQuaSach !=null){
                        hoaQuaSachList.clear();
                        hoaQuaSachList.addAll(Arrays.asList(hoaQuaSach));
                        setAdapter();
                    }
                    else
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                HoaQuaSach hoaQuaSach = hoaQuaSachList.get(i);
                saveIdStudent = hoaQuaSach.getId();
            }
        });
    ...
    private void setAdapter(){
        if(hoaQuaAdapter ==null){
            hoaQuaAdapter = new HoaQuaAdapter(this,R.layout.activity_item_list_hoa_qua_sach, hoaQuaSachList);
